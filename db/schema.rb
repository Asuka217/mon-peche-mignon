...
ActiveRecord::Schema.define(version: 2020_11_06_135417) do
  ...
  create_table "achievements", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["training_id"], name: "index_achievements_on_training_id"
  ...
  add_foreign_key "achievements", "trainings"
